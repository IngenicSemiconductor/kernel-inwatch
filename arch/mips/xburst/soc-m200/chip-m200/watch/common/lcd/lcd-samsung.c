...
int samsung_reset(struct lcd_device *lcd)
{
...
struct lcd_platform_data samsung_data = {
	.reset = samsung_reset,
};

struct mipi_dsim_lcd_device samsung_device={
	.name		= "samsung-lcd",
	.id = 0,
	.platform_data = &samsung_data,
};
...
struct jzfb_platform_data jzfb_pdata = {
	...
	.bpp = 32,		/* set 32bpp framebuffer rgba8888 */
