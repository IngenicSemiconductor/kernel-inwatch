...
/* if you don't know which vender TP that you are using, you can use the same #include"..."
 *  in both msg2xxx_xxxx_update_bin and msg2xxx_yyyy_update_bin
*/

//#ifdef CONFIG_AW808_HW_X3
//static u8 msg2xxx_xxxx_update_bin[] = {
////	#include "MSG22S_RGF015H0279A1_V0x0001.0x0003_DEMO_MODE_20140104.i"
//};
//
//static u8 msg2xxx_yyyy_update_bin[] = {
////	#include "MSG22S_RGF015H0279A1_V0x0001.0x0003_DEMO_MODE_20140104.i"
//
//};
//
...
//            if ((nDeltaX == 0) && (nDeltaY == 0))
          if(
            ...
            {   /* one touch point */
                ...
                pInfo->tPoint[0].nX = (nX * pdata->touch_screen_x_max/*TOUCH_SCREEN_X_MAX*/) / TPD_WIDTH;
                pInfo->tPoint[0].nY = (nY * pdata->touch_screen_y_max/*TOUCH_SCREEN_Y_MAX*/) / TPD_HEIGHT;
                DBG("[%s]: [x,y]=[%d,%d]\n", __func__, nX, nY);
            ...
            {   /* two touch points */
                ...
                pInfo->tPoint[1].nX = (nX2 * pdata->touch_screen_x_max/*TOUCH_SCREEN_X_MAX*/) / TPD_WIDTH;
                pInfo->tPoint[1].nY = (nY2 * pdata->touch_screen_y_max/*TOUCH_SCREEN_Y_MAX*/) / TPD_HEIGHT;
...
//    if (eSwId == eVendorId)
    if (1) /* holitech's tp's ID make the eSwId not equel to eVendorId, so here shoule make it enter the "if"*/
    {
...
#if defined(CONFIG_ENABLE_FIRMWARE_DATA_LOG) || defined(CONFIG_ENABLE_GESTURE_WAKEUP)
    End:
#endif
    mutex_unlock(&g_Mutex);
}
...
static void _DrvFwCtrlCoordinate(u8 *pRawData, u32 *pTranX, u32 *pTranY)
{
    ...
    {
        /* one touch point */
        *pTranX = (nX * pdata->touch_screen_x_max/*TOUCH_SCREEN_X_MAX*/) / TPD_WIDTH;
        *pTranY = (nY * pdata->touch_screen_y_max/*TOUCH_SCREEN_Y_MAX*/) / TPD_HEIGHT;
        DBG("[%s]: [x,y]=[%d,%d]\n", __func__, nX, nY);
